jQuery(document).ready(function ($) {
    ...
    var initialGreeting = localStorage.getItem('chatgpt_initial_greeting') || 'Hello! pls How can I help you today?';
    localStorage.setItem('chatgpt_initial_greeting', initialGreeting);
    var subsequentGreeting = localStorage.getItem('chatgpt_subsequent_greeting') || 'Hello pls again! How can I help you?';
    ...
    function initializeChatbot() {
        ...
        if (isFirstTime) {
            ...
            initialGreeting = localStorage.getItem('chatgpt_subsequent_greeting') || 'pls Hello again! How can I help you?';
